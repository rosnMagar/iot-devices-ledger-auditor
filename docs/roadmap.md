...
- [x] Branching model matches the repo: `prod` is the GitHub default and deploy branch, `dev` is the integration branch — IOT-48. See [`branching-and-cicd.md`](branching-and-cicd.md).
