...
## Acceptance criteria
- [ ] IAM user `iot-ledger-deployer` created
- [ ] Policies attached: Lambda, CloudFormation, S3 (scoped tighter in Phase 5)
- [ ] Access key ID + secret generated and stored for GitHub secrets
